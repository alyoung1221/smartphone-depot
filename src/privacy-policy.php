	...
	<main>
		<section>
			<p>
				...
				applies to www.smartphone-depot.com and Smartphone Depot Inc and governs data collection 
				and usage. For the purposes of this Privacy Policy, unless otherwise noted, all references to 
				Smartphone Depot Inc include www.smartphone-depot.com and Smartphone Depot. The Smartphone Depot 
				website is a Ecommerce site. By using the Smartphone Depot website, you consent to the data practices 
				...
				requested.
				<br>
				Smartphone Depot may also use your personally identifiable information to inform you of other products or services available 
				...
				<br>
				Smartphone Depot may disclose your personal information, without notice, if required to do so by law or in the good faith 
				...
				– SSL Protocol
				<br>
				When personal information (such as a credit card number) is transmitted to other websites, it is protected through the 
				use of encryption, such as the Secure Sockets Layer (SSL) protocol.
				<br>
				...
				If you would like to stop receiving marketing or promotional communications via email from Smartphone Depot, you may opt 
