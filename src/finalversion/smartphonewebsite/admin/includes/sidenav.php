<div id="sidenav">
			...
			<ul class = "lab">
				<li> <a href="help.php">Training Help Tools</a></li>
				...
				<li> <a href="addnewphonetype.php">Add New Product Model</a></li>
				<li> <a href="purchase.php">Purchase</a></li>
				<li> <a href="expense.php">Expenses</a></li>
				<li> <a href="stock.php">Stock</a></li>
				<li> <a href="addnewModelphone.php">Add Product Model Detail</a></li>
			</ul>
