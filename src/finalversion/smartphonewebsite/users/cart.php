   ...
   while ($row = $stmt->fetch(PDO::FETCH_ASSOC))
	{
        ...
        <div class='#'>
			...
			<?php echo "<div class='product-name m-b-10px'>{$idSmartPhones}</div>"; ?>
                <div class='#'><h4><?php echo $row['ProductName'] ?> </h4><?php echo "Quantity:" ?></div>
 <!--
	...
	!-->			
				...
				<?php echo "<div class='product-id' style='display:none;'>{$idSmartPhones}</div>";?>
                    ...
                    <div class='input-group'>
                        ...
                        <input class="form-control cart-quantity" type='number' name="quantity" value="<?php echo $quantity ?>"  min='1' />
                            <span class='#'>
                ...
                <!-- delete from cart -->
                <a href='remove_from_cart.php?id=<?php echo $row['idSmartPhones'] ?> ' class='btn btn-default'> Delete  </a>
            </div>
			...
			<div>
				Grade  : <?php echo $grade ?> (<a href='our-process.php'> See detail </a>)
			</div>
			<div class="#">
